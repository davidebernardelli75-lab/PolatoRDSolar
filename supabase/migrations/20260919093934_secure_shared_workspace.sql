...
Creates `app_members` table for membership-based access control.
Applies shared CRUD policies on plants, panels, panel_photos for authenticated
app members. Also sets up storage bucket policies for solar-archive.
*/
