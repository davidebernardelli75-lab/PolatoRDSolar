    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-5 max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          {scanError && <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg text-amber-700 text-xs flex items-start gap-2"><span className="flex-shrink-0 mt-0.5">!</span><span>{scanError}</span></div>}
